...
public class EntidadResena {
    ...
    // Constructor
    public EntidadResena(Long idResena, int idUsuario, int idJuego, boolean recomendado, String textoResena, double horasJugadas, LocalDateTime fechaPublicacion, LocalDateTime fechaUltimaEdicion, EstadoResena estadoResena) {
        ...
        this.estadoResena = EstadoResena.PUBLICADA;
    }
